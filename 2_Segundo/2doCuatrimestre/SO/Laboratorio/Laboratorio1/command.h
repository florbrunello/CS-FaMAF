...
char **scommand_nth_argv (scommand self);
/* Crea un arreglo un arreglos con los argumetnos del self.
Aseguramos que: el arreglo de punteros debe terminar con un puntero a NULL
(por lo especificado en la man execvp).
*/
/*
