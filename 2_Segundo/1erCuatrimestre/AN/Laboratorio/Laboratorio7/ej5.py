"""
Ejercicio 5:
Asignacion de tareas. Una compania monta un sistema de produccion en un proceso dividido
en 4 tareas denominadas M, N, P y Q que pueden realizarse en cualquier orden e 
indistintamente por 4 equipos. En la siguiente tabla aparecen: 
a) El tiempo en horas que emplearia cada equipo en realizar la tarea completa.
b) Las horas disponibles por cada equipo.
c) El coste de la hora de trabajo de cada equipo. 
Se quiere conocer el numero de horas de trabajo que deben asignarse a cada equipo para 
que se minimice el coste total del montaje del sistema.
"""
