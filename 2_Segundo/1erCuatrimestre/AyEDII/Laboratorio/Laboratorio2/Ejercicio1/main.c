...
/*
Arreglos: Comienzan de cero (no en uno). La ordenacion no es trivial. 
(no ignorar el assert). 
Difenernciar sin sing . Un arreglo no peude tener tamaños sin signo. 
Un iterador debe ser unsigned int. 
Los iteradores no pueden ser enteros. 0 - 1 = 2 ** 32 - 1 si es de tipo 
unsigned int porque tiene 32 bits para representar
y al hacer la resta, -> Violacion de segento si se va de la memoria. gdb (dubuger)
*/
