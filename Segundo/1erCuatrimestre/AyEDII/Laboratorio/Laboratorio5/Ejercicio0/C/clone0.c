...
/* 
Modifico la variable clone (que se almacena en memoria estática), para que 
el puntero output apunte a memoria dinamica y el usuario pueda acceder a esa memoria. 
*/
